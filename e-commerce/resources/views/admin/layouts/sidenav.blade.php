...
<div class="user-details">
 <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
  ...
  </div><a class="btn btn-danger btn-block btn-glow btn-log-out mx-1 pull-up" href="admin-login.html" > Log Out!</a>
   ...
   <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
       <a class="nav-link "  href="admin-profile.html">
         <span class="user-profile"><img src="{{asset('images/admin/avatar-s-12.jpg')}}" class="img-circle pull-up" alt="user avatar"></span>
       </a>
