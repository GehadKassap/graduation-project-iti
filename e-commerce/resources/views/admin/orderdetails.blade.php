				...
				<div class="card-content">
					<div class="card-body py-0">
						<div class="d-flex justify-content-between lh-condensed">
							<div class="order-details text-center">
								<div class="product-img d-flex align-items-center">
									<img class="img-fluid" src="{{asset('images/admin/pro4.png')}}" alt="Card image cap">
								</div>
							</div>
							<div class="order-details">
				...
				<div class="card-content">
					<div class="card-body py-0">
						<div class="d-flex justify-content-between lh-condensed">
							<div class="order-details text-center">
								<div class="product-img d-flex align-items-center">
									<img class="img-fluid" src="{{asset('images/admin/pro3.png')}}" alt="Card image cap">
								</div>
							</div>
							<div class="order-details">
				...
				<div class="card-content">
					<div class="card-body py-0">
						<div class="d-flex justify-content-between lh-condensed">
							<div class="order-details text-center">
								<div class="product-img d-flex align-items-center">
									<img class="img-fluid" src="{{asset('images/admin/pro2.png')}}" alt="Card image cap">
								</div>
							</div>
							<div class="order-details">
